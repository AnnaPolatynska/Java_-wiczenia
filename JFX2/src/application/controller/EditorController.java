...
public class EditorController {
    ...
    void saveApp(ActionEvent event) throws FileNotFoundException {
    	// nowe okno poza scene bilderem wyœwietlaj¹ce  "Zapisano!" po zapisie
    	Frame df=new Frame();
    	JOptionPane op= new JOptionPane();
    	
    	if(Ta_main.getText().equals("")){
    		op.showMessageDialog(df,"Musisz podaæ nazwê pliku");
    	}else{
    		//zapis do pliku
        	File f = new File("C:\\Users\\Ania\\Desktop\\BED_Æwiczenia\\"+ta_name.getText()+".txt");
    		...
    		while(sc.hasNextLine()){
    			...
    			pw.println(line);
    	     	...
    	     	// C:\Users\Ania\Desktop\BED_Æwiczenia\f.txt
