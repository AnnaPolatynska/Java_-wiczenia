 ...
 * Nale¿y wydobyæ trzeci¹ od koñca literê drugiego Stringa. 
 * Na podstawie tej litery dzielimy pierwszy String na czêœci. 
  */
...
public class J31 {
	...
	public static void main(String[] args) {
		...
		// wypisuje jedynie po sobie nie podstawia i generuje b³¹d ? wzór M
			...
			System.out.println("d³ugoœæ wyrazu minus 3 to: "+ (g.length()-3));
			// 2 sposób wydobycia 3 od koñca
