...
public class Szyfrowanietekstu {
	...
	public static void main(String[] args) {
		...
		char letter2 = 'o'; 
		char letter3 = 't'; 
		System.out.println("B³êdne \"sumowanie\" znaków"); //zwraca liczbê z alfabetu aski dla liter k+o+t//
		...
		System.out.println("Narrowing (zawê¿a do ca³kowiej w dó³): " + narrowing);
		System.out.println("widening (dostawia po przecinku): " + widening);
		long e = Math.round(numer3);
		System.out.println(e);
		
		
		//J11 podziel liczby float i wyœwietl jako int//
		float num1 = 10.789f;
		float num2 = 2.689f;
