package Tablice;
//J47
/*Wykonaj operacje dodawania dwóch macierzy jednostkowych wymiaru 3x3 za pomoc¹ tablic. */
...
public class J47_dod_maciery {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < tablA.length; i++){ 
			...
			System.out.print((tablA[i][j]) +"\t"); // "\t" enter miêdzy wierszami dodawanie macierzy
			}
			System.out.println("");
		...
		for(int i = 0; i < tablA.length; i++){ 
			...
			//j to kolumny
				...
				System.out.print((tablA[i][j])+(tablA[i][j])+"\t"); // "\t" enter miêdzy wierszami dodawanie macierzy
			}
			System.out.println("");
		}
