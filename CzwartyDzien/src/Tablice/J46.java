...
/*public class J46 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Podaj 1 liczbê do przekszta³cenia na kod binarny: ");
		int liczba = costam.nextInt(); // nextDouble  czyta kolejn¹ liczbê zmiennoprzecinkow¹ //
		int licznik = 0;
		costam.nextLine();
		...
		while(liczba>0);
		System.out.println( "twój kod binarny: " );
