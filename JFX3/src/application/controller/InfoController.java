...
import javafx.scene.input.MouseEvent;
	...
	public class InfoController {
	    ...
	    private ComboBox<String> combo;//wstaw jakiego typu wartoœci
	    ...
	    void sendAction(MouseEvent event) throws FileNotFoundException {
	    	...
	    	info+= "znajomoœæ jezyka angielskiego" + rb_sel +"\n";
    		...
    		PrintWriter pw= new PrintWriter("C:\\Users\\Ania\\Desktop\\BED_Æwiczenia\\" + tf_first.getText() + tf_last.getText()+"txt");
    		pw.println(info);
	    	pw.close();
	    	Alert a = new Alert(AlertType.INFORMATION);//okno z informacj¹ o b³êdzie
		...
		@FXML
	    private TextField tf_other;// jak inne jêzyki to pole aktywne
	    @FXML
