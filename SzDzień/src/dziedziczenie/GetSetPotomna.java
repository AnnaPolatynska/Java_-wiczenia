...
public class GetSetPotomna extends GetSetBazowa {
	...
	public static void main(String[] args) {
		...
		gs1.setPesel(1);
		gs1.rok = 2001;
		System.out.println("gs1 " + gs1.getImie()+ " "+gs1.getPesel()+" "+gs1.rok+" "+gs1.miesiac);
		//gs1.infoBaza();
		GetSetPotomna gs2 = new GetSetPotomna(95465232, 2000);
		System.out.println("gs2 " + gs2.getImie()+ " "+gs2.getPesel()+" "+gs2.rok+" "+gs2.miesiac);
		GetSetPotomna gs3 = new GetSetPotomna("Nazwisko");
		GetSetPotomna gs4 = new GetSetPotomna("Imie","");
		System.out.println("gs3 " +gs3.getImie()+ " "+gs3.nazwisko);
		System.out.println("gs4 " + gs4.getImie()+ " "+gs4.nazwisko);
		}
}
